...
public class MybatisPlusTest {
    ...
    public void testGenerator()  {
        ...
        GlobalConfig globalConfig = new GlobalConfig.Builder()
                .author("kly")// 设置作者
                .outputDir("F:\\JavaStudy\\gulixuyuan\\guli_parent\\service\\service_ucenter\\src\\main\\java")
                /* 设置生成路径*/
                .fileOverride() // 设置文件覆盖
        ...
        StrategyConfig strategyConfig = new StrategyConfig.Builder()
                ...
                .addTablePrefix("ucenter_")  // 设置表前缀
                .addInclude("ucenter_member")
                // enties
                .entityBuilder()
                .enableLombok()
